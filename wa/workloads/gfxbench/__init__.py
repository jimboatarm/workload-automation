...
class Gfxbench(ApkUiautoWorkload):
    ...
    parameters = [
        ...
        Parameter('pkg', kind=str, default='net.kishonti.gfxbench.vulkan.v50000.corporate',
                  description=('Package name to be used')),
    ]
    ...
    def update_output(self, context):
        ...
        if failed or detected_results < len(regex_matches):
            msg = "The workload has failed to process all scores. Expected >={} scores, There are {} missing scores."
