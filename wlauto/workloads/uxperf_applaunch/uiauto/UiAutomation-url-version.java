...
public class UiAutomation extends BaseUiAutomation {
	...
	public void runUiAutomation() throws Exception{
		...
		getParameters();
		File jarFile = new File("jar:file://sdcard/wa-working/com.arm.wlauto.uiauto.adobereader.jar!/assets/");
		URLClassLoader classloader = new URLClassLoader(new URL[] {jarFile.toURL()}, System.class.getClassLoader());
		URL url = jarFile.toURI().toURL();
		Log.d("URL used:", url.toString());

		URL[] urls = new URL[]{url};
		ClassLoader cls =  new URLClassLoader(urls);
		//ClassLoader cl = ClassLoader.getSystemClassLoader().getParent();
		Class uiautomation = null;
		//PathClassLoader cls = new PathClassLoader("/sdcard/wa-working/com.arm.wlauto.uiauto.adobereader.jar", cl);
		Object o = null;
		try {
			uiautomation = cls.loadClass("com.arm.wlauto.uiauto.adobereader.UiAutomation");
			Log.d("Canonical name:", uiautomation.getCanonicalName());
			o = uiautomation.newInstance();
		}catch (ClassNotFoundException e) {
		e.printStackTrace();
		}
		//Method m = uiautomation.getDeclaredMethod("setWorkloadParameters",null); 
    ...
    public void runApplaunchSetup() throws Exception{
		...
		Log.d("Lala", "checking");
        launch_workload.setWorkloadParameters();
